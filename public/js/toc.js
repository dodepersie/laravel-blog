$(document).ready(function() {
    if ($("#toc").length) {
        ...
        $("h2").each(function() {
            ...
            fullString += "<li># <button data-scroll-to='toc_" + ID + "'>" + h2Content + "</button>";
            ...
            h3Elements.each(function() {
                ...
                nestedList += "<li># <button data-scroll-to='toc_" + ID + "'>" + h3Content +
                    "</button></li>";
            });
        ...
        function checkActiveHeader() {
            ...
            if (activeHeaderId) {
                $("#tableOfContents button[data-scroll-to='" + activeHeaderId + "']").addClass("active");
            }
        }
