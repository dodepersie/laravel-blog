...
@section('container')
    ...
    <div class="flex justify-center mt-5">
        <div
            class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mb-4">
                ...
                <div>
                    ...
                    <div data-popover id="popover-description" role="tooltip"
                        ...
                        <div class="p-3 space-y-2">
                            <h3 class="font-semibold text-gray-900 dark:text-white">{{ @__('register.password_must') }}
                            </h3>
                            <ol>
