    ...
    <main class='container w-full lg:w-3/4 xl:w-1/4 mt-24 mx-auto overflow-x-hidden'>
        ...
        <div
            ...
            <form class="space-y-6" action="/register" method="POST">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="password" id="password" placeholder="••••••••"
                            ...
                            required>
                        <button type="button" class="text-slate-900 dark:text-white absolute right-2.5 bottom-1"
                ...
                <button type="submit"
                    class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('register.register') }}</button>
