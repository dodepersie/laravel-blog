    ...
    <div class="container max-w-md mx-auto p-4">
        <div
            ...
            <div class="flex justify-center my-10">
                <img src="{{ asset('assets/img/logo-1000px-black.png') }}" class="block dark:hidden h-[30px]"
                    alt="Mahadi Saputra's Logo" />
                <img src="{{ asset('assets/img/logo-1000px-white.png') }}" class="hidden dark:block h-[30px]"
                    alt="Mahadi Saputra's Logo" />
            </div>
                ...
                <div class="flex justify-between items-center">
                    <div class="text-sm text-center font-medium text-gray-500 dark:text-gray-300">
                        Belum punya akun? <a href="{{ route('register') }}"
                            class="text-sky-700 hover:underline dark:text-sky-500">Daftar</a>
                    </div>

                    <button type="submit"
                        class="px-3 py-2 text-base font-medium text-center text-gray-50 bg-blue-700 dark:bg-slate-900 dark:hover:bg-slate-900/50 rounded-lg hover:bg-blue-600/90">Masuk</button>
                </div>
            </form>
        </div>
    </div>
