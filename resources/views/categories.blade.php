...
<div class="container max-w-screen-xl mt-24 mx-auto">
  ...
  <h1 class="mb-8 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl leading-relaxed"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{{ __('category.categories') }}</span> {{ __('category.categories_y') }}</h1>
