    ...
    <main class="relative container max-w-[74.5rem] mx-auto px-4 lg:px-0 text-xl">
        ...
        <div class="lg:grid grid-cols-12 justify-start items-start gap-0 lg:gap-8 w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="pb-4 pt-10 lg:px-12 col-span-7">
                ...
                <!--Section: Text-->
                <article id="contents"
                    class="content text-[18px] leading-loose tracking-[-.012em] text-gray-900 dark:text-gray-50">
                    {!! $post->body !!}
                </article>
                <!--Section: Text-->
                ...
                <section class="mt-5 pb-auto md:pb-2 dark:text-gray-50 leading-loose">
                    <div
                        ...
                        <div>
                            ...
                            <div
                                class="mt-6 flex flex-col justify-between gap-y-2 sm:flex-row sm:items-center sm:gap-y-0">
                                ...
                                <div class="pt-4 font-mono text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    <div class="flex items-center space-x-1.5 pt-2">
                                        <a href="https://saweria.co/mahadisaputra" target="_blank"
                                                class="inline-flex items-center bg-gray-600 text-white p-2 rounded-full">
                                                <img src="https://saweria.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcapy_happy.603c7293.svg&w=384&q=75" class="w-4 h-4 mr-2" /> Saweria
                                            </a>
                                    </div>
                                </div>
                            </div>
