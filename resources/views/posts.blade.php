    ...
    <main>
        @if ($posts->count())
            <div class="flex flex-col justify-center items-center p-10 -mt-4 gap-4 bg-[#FDE3E2] dark:bg-[#2A323E]">
                ...
                <h1 class="text-4xl text-center font-extrabold text-gray-900 dark:text-gray-50 md:text-5xl lg:text-4xl">
                    {{ $title }}
                </h1>
            </div>
                    ...
                    @foreach ($posts as $post)
                        <div class="bg-white rounded-lg shadow dark:bg-slate-900">
                            <div class="space-y-2">
                                ...
                                <div class="flex-auto h-32 p-[1.25rem]">
                                    <div class="mb-2">
                                    ...
                                    <a href="{{ route('post', $post->slug) }}">
                                        <h5
                                            class="mb-2 text-lg font-bold tracking-tight leading-[30px] text-gray-900 dark:text-white">
                                            {{ $post->title }}</h5>
                                    </a>
                                </div>
                            </div>
        ...
        @else
            <div class="text-center bg-[#E9E9E9] dark:bg-[#444A54] -mt-4 p-10">
                <h1
                ...
                <p class="text-lg font-normal leading-loose text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                    Kamu masih bisa membaca artikel yang lain!</p>
                <button onclick="window.history.back()"
                    class="inline-flex items-center justify-center px-5 py-3 my-5 text-base font-medium text-center text-gray-50 bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
