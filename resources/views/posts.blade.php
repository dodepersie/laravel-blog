    ...
    <main class="container max-w-screen-sm md:max-w-screen-md lg:max-w-screen-xl mt-24 mx-auto overflow-hidden">
                ...
                <div class="p-5">
                    <div class="mb-3">
                        <a href="{{ '/' . app()->getLocale() . '/posts/?category=' . $posts[0]->category->slug }}"><span
                                class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{ $posts[0]->category->name }}</span></a>
                            ...
                            <div class="p-5">
                                <div class="mb-3">
                                    <a href="{{ '/' . app()->getLocale() . '/posts/?category=' . $post->category->slug }}"><span
                                            class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{ $post->category->name }}</span></a>

                                    <span
                                        class="bg-gray-100 text-gray-800 text-sm font-medium mr-1 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300 mb-2">{{ \Carbon\Carbon::parse($post->created_at)->format('d.m.Y') }}</span>
                                </div>
        ...
        @else
            <div class="text-center">
                <h1
                    class="py-5 text-4xl font-extrabold leading-relaxed tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                ...
                <button
                    onclick="window.history.back()"class="inline-flex items-center justify-center px-5 py-3 my-5 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
