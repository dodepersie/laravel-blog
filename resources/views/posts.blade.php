...
@if ($posts->count())
    ...
    <div class="text-center">
      <h1 class="py-5 mb-4 text-4xl font-extrabold leading-relaxed tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">{{ __('posts.not_found') }}</h1>
      <p class="mb-6 text-lg font-normal leading-loose text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">{{ __('posts.not_found_desc') }}</p>
      <button onclick="window.history.back()"class="inline-flex items-center justify-center px-5 py-3 my-5 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
